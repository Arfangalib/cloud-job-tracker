...
import { claimNextWorkItem, completeWorkItem, enqueue, failWorkItem } from "./services/queue.js";
...
/**
 * Start the background work loop. Assumes the DB is already connected. Used by the
 * standalone worker entry (worker.js) and, for the free-tier demo, in-process with
 * the API (index.js, RUN_WORKER_INLINE=true). In production the worker runs as its
 * own service.
 */
